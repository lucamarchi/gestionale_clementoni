...
store.factory('stockFactory', ['$resource', 'myConfig','features', function ($resource, myConfig, features) {
    return {
		resource: function (){
		...
		createMapProducts: function (products) {
			...
			var spessorArray = features.spessori;
			var largArray = features.classiLarghezza;
