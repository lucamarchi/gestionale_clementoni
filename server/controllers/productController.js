...
module.exports = function(app, apiRoutes) {
    ...
    apiRoutes.get('/products', function(req, res, next) {
        Product.findAll()
    ...
    apiRoutes.get('/product/:product_id', function(req,res,next) {
    ...
    apiRoutes.delete('/product/:product_id', function(req,res,next) {
    ...
    apiRoutes.put('/product/:product_id', function(req,res,next) {
