...
module.exports = function(app, apiRoutes) {
    ...
    apiRoutes.get('/articles/:status', function(req,res,next) {
    ...
    apiRoutes.put('/article/stock/:article_id', function(req,res,next) {
    ...
    apiRoutes.put('/article/complete/:article_id', function(req,res,next) {
        var articleId = req.params.article_id;
