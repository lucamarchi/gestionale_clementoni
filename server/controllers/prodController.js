...
module.exports = function(app, apiRoutes) {
    ...
    apiRoutes.get('/prods', function(req, res, next) {
        Prod.findAll()
    ...
    apiRoutes.get('/prod/:prod_id', function(req,res,next) {
    ...
    apiRoutes.post('/prod', function(req,res,next) {
    ...
    apiRoutes.delete('/prod/:prod_id', function(req,res,next) {
        var prodId = req.params.prod_id;
    ...
    apiRoutes.put('/prod/:prod_id', function(req,res,next) {
        var prodId = req.params.prod_id;
        var prod = req.body.prod;
        var promises = [
        ...
        apiRoutes.get('/prova1', function(req,res,next) {
            Prod.findNewNumeroProd().then(function(number) {
                console.log(number)
            })
        })
